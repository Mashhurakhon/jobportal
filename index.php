                            ...
                            <div class="col-xl-8">
                                ...
                                <form action="job_listing.php" method="get" class="search-box">
                                    <div class="input-form">
                                        <input type="text" name="profession" placeholder="Название профессии">
                                    </div>
                                    <div class="select-form">
                                        <div class="select-itms">
                                            <select name="region" id="select1">
                                                <option>все</option>
                                            <?php 
                                            ...
                                            ?>
                                                <option name="<?=$row['id']?>"><?=$row['locality'];?></option>
                                            <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="search-form">
                                        <!-- <a href="job_listing.php" class="btn">Найти</a> -->
